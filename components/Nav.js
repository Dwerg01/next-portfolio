...
const Nav = () => {
  ...
  return (
    ...
    h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16
    xl:max-w-md xl:h-screen '>
      <div 
      className='flex w-full xl:flex-col items-center justify-between xl:jusitfy-center 
      gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] bg-red-200/10 xl:h-max
